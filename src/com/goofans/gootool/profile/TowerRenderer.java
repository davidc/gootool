...
public class TowerRenderer implements ImageObserver
{
  ...
  public TowerRenderer(Tower t) throws IOException
  {
    ...
    File ballFile = WorldOfGoo.getResource("res\\balls\\Drained\\body.png");
    ...
    File groundFile = WorldOfGoo.getResource("res\\levels\\wogcd\\groundTile.png");
    groundImage = ImageIO.read(groundFile);

    File skyFile = WorldOfGoo.getResource("res\\levels\\wogcd\\skytile.png");
