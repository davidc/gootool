package net.infotrek.gootool;

import net.infotrek.gootool.model.Configuration;
import net.infotrek.gootool.util.Version;
import net.infotrek.gootool.util.WogExeFileFilter;
import net.infotrek.gootool.view.MainFrame;
...
//    }
  ...
  {
    boolean devMode = System.getProperty("idea.launcher.port") != null;

    // Initialise the logger to write to tempdir
    Handler fileHandler;
    fileHandler = new FileHandler("%t/gootool%u.log", true);
...
//      consoleHandler.setFormatter();
    ...
    Logger.getLogger("net.infotrek.gootool").setLevel(Level.FINEST);
